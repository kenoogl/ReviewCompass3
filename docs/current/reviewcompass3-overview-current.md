...
| 評価の運用集計コマンド（データ取得計画の順序5・v6＝時系列第一次・欠落由来まで） | 一部完了（v7＝系統意味づけ等が候補） | 2026-08-18 | `records/development/2026-08-18-operational-metrics-dataset-v6.json`と同Evidence v1〜v6 |
| 最終公開評価 | 未着手 | — | — |
