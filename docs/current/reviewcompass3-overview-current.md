...
| 評価の運用集計コマンド（データ取得計画の順序5・v3＝表cell束縛照合まで） | 一部完了（v4＝H4手動記入・コスト等が繰り越し） | 2026-08-18 | `records/development/2026-08-18-operational-metrics-dataset-v3.json`と同Evidence v1〜v3 |
| 最終公開評価 | 未着手 | — | — |
