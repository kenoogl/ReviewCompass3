...
- supersedes：`records/task-contract/2026-08-17-request-builder-candidate-v1.md`、
  SHA-256 `5fe3aea94a4852eb43703f383e1195496537df599c267a6f2b7eae3da4825935`
- 訂正根拠：起草側自己レビュー
  `records/development/2026-08-17-request-builder-v1-self-review-v1.md`の
  SR-C11-1（assembleのnew-only停止理由の明示）、SR-C11-2（checkの再実行性とcommit検査順序の明記）、
  SR-C11-3（許可model定数の流用一覧への追加）
