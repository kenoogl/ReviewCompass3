...
- supersedes：`records/task-contract/2026-08-16-external-reviewer-single-send-candidate-v3.md`、SHA-256 `a24b560c5fc7e7a919aff2884713f4bd18940735f0257cb02e721fb118c3e433`
- 訂正根拠：Gemini独立確認（Human中継・判定`修正要`・停止原因3件）
  `records/development/2026-08-16-external-reviewer-single-send-v3-independent-review-v1.md`、SHA-256 `5198c5fff9a63820e603a613b8db9f4c5cf91ac00ffe2dd90e57fb4c001b9ac0`
- 訂正範囲：原因1（repository_rootの実在検査とsource_files pathの構成要素規則）、原因2（識別子の高乱雑性検査の
  扱いを非除外のまま仕様として明示。除外案は台帳経由の漏えい経路になるため不採用、理由は判定record§2）、
  原因3（操縦LLMによる台帳削除が機械層で防げない限界の明示）
