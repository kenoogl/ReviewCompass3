...
- supersedes：`records/session-handoffs/2026-08-11-no-tool-bootstrap-scope-review-request-v1.md`
- Human裁定：`records/session-handoffs/2026-08-11-no-tool-bootstrap-scope-review-prompt-findings-human-decision-v1.md`
- Human裁定SHA-256：`e63e36f9323eb1b16382cc0d3d4c560aab26ff82678ab4b172a2f9f91299d7bb`
...
固定材料は、指定commitでのGit blob、現在file、記載SHA-256、commit済み状態を全件照合する。一件でも
欠落または不一致なら追加探索へ進まず、`verdict: reported_unverified`、`stop_reason: stale_input`とし、
未評価の課題を列挙して停止する。
