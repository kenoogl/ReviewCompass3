# 実験ケースcase-003（条件C）の妥当性レビュー 独立確認依頼record（headless起動対象・Claude→Reviewer）
...
- 対象material：
- `docs/evaluation/rq2-cases/case-003/contract-interpretation-scope.md`（SHA-256 `850dfcbe6aff70f1f9f54deb75bd4377001284e697e8bd0cd06bf6230e95ca95`）
- `docs/evaluation/rq2-cases/case-003/procedure-result-reading.md`（SHA-256 `b600cb2ffe48186c01b650fa41187f206f19c817f1171fad1a565dc89dd4f2ad`）
...
reviewcompass3-reviewer-launch launch \
  ...
  --request records/session-handoffs/2026-08-17-rq2-case-003-c-request-v1.md \
  --expected-sha256 <本record commit後のSHA-256> \
  --private-root <repo外私有領域の絶対パス> \
  --run-id <実行識別子>
```

3. アダプタが判定recordを`records/session-handoffs/2026-08-17-rq2-case-003-c-verdict-v1.md`へ機械転記して単独commitし、事後照合4点を実行する。
