...
**執筆＝英語初稿の組版**（WSSE様式LaTeXへの流し込み・図1 TikZ組み込み・文献整形・転記数値の確定recordとの機械照合）。**開発＝順序選択待ち**（候補：縦C合議＝3判定役×複数modelの材料が揃った／RQ2追試／運用集計v8／codex再レビュー任意）。
